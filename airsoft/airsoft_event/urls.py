...
urlpatterns = [
    ...
    django.urls.path("<int:pk>/registration",
                     TeamRegistrationView.as_view(),
                     name="team_reg"),  # airsoft_registration
    django.urls.path("<int:pk>/registration_by_vote",
                     TeamVoteRegistrationView.as_view(),
                     name="team_reg_vote"),
