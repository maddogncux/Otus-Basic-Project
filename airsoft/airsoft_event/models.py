...
class Event(models.Model):
    ...
    polygon = models.ForeignKey("airsoft_polygon.Polygon",
                                on_delete=models.PROTECT,
                                blank=True, null=True
                                )
    Description = models.TextField(blank=True, null=True)
    banner = models.ImageField(upload_to='event_banner',
                               blank=True,
                               default='nopic.jpeg'
                               )
    ...
    def get_absolute_url(self):
        return reverse(f'/event/{self.pk}')
...
class Sides(models.Model):
    ...
    scenario = models.ForeignKey("airsoft_event.Scenario",
